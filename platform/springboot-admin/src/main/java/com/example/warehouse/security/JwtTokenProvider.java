...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(
            @Value("${warehouse.auth.jwt-secret:cdc-warehouse-default-secret-key-min-256-bit}") String secret,
            @Value("${warehouse.auth.jwt-expiration-ms:86400000}") long expirationMs) {
